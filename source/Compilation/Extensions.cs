...
{
    internal unsafe struct SByteString : IDisposable
    {
        public int Length { get; private set; }

        public sbyte* Value { get; private set; }

        public SByteString(ReadOnlySpan<char> input)
        {
            Length = 0;
            Value = null;
            if (input.IsEmpty)
        ...
        private void AllocateString(ReadOnlySpan<char> input)
        {
        ...
        private void AllocateEmptyString()
        {
        ...
        public static implicit operator sbyte*(in SByteString value)
        {
            return value.Value;
        }
        ...
        {
            return new ReadOnlySpan<byte>(Value, Length).ToString();
        }
    }
